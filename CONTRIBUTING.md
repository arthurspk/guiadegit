# Como contribuir com o Guia de Git
...
- **Novo recurso** (curso, livro, canal, ferramenta, artigo, comunidade): abra uma issue com o template *Sugestão de recurso* ou envie um pull request.
...
3. **Descrição de 1 linha** dizendo o que é e por que vale o clique. Se o recurso for pago, diga isso na própria descrição (ex.: "curso pago da Alura").
...
1. Faça um fork e crie uma branch a partir da `main` (ex.: `feat/novo-curso-git`).
2. Edite o `README.md`.
